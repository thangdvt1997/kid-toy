 ...
 * Formatting MUST go through BigInt — never coerce this value with the
 * `Number` global — so a 15-digit price still renders exactly, with no
 * `e+14` scientific notation.
 */
